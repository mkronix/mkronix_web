...
const Footer = () => {
    return (
        <footer id='contact' className="bg-white text-black">
            <div className="bg-white relative z-10 h-96 flex justify-center items-center flex-col mx-auto px-4 py-12 text-center">
            ...
            <div className="relative z-10 pointer-events-none text-off-white py-6">
