const LabelCard = ({ title, description }) => {
    return (
        <div className="spotlight-text fadeOutAnimation max-w-[324px] w-full h-[200px] bg-card-bg p-4 rounded-lg shadow-lg flex flex-col items-center justify-center text-center">
