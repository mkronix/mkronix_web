...
const CommonHeaderText = ({ text }) => {
    return (
        <div className="relative z-10 pointer-events-none flex h-screen w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl">
