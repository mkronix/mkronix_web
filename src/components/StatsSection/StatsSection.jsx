...
const RepeatedUi = ({ values, text }) => {
    return (
        <div className='md:border-r border-r-white/30'>
            <p className="text-dynamic-p font-bold text-lime-400">{values}<span className="text-dynamic-p">+</span></p>
...
const StatsSection = () => {
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center my-8 text-white/60 relative">
            <RepeatedUi values={25} text={"Success Project"} />
            <RepeatedUi values={3} text={"Years Experience"} />
            <div className='max-md:block text-parrot hidden absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]'>
            ...
            <RepeatedUi values={1} text={"Product Launched"} />
            <RepeatedUi values={3} text={"Startup Raised"} />
        </div>
    )
}
